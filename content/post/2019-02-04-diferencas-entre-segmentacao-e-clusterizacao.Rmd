...
Quando falamos sobre clusterização, estamos trabalhando com aprendizado não supervisionado, ou seja, não vamos delimitar previamente como nosso segmento deva ser, e sim vamos aplicar métodos que que buscam similaridades que podem ser não óbvias. Já quando estamos trabalhando com segmentação, podemos pensar em um afunilamento, ou em slices (cortes em pedaços) da base em caracteristicas previamente conhecidas.  
