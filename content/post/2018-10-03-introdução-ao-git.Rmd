...
Git é um sistema de controle de versão que permite o gerenciamento de um repositório remoto (armazenado em um site, como [GitHub](https://github.com/), [GitLab](https://about.gitlab.com/), [Bitbucket](https://bitbucket.org/)), fazendo *clone* e alteração de código, além de outras funcionalidades. Repositório é, basicamente, uma pasta com os arquivos do nosso projeto. Como vamos utilizar o R, o repositório será, no nosso computador, vinculado a um projeto do R. Além disso, é um software livre. Faça [aqui](https://git-scm.com/downloads) o download do Git
