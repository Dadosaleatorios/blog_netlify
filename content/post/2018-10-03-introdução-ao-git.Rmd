...
É um site que oferece hospedagem gratuita para *repositórios*. Ou seja, nele podemos criar e manter repositórios, com vários tipos de arquivos possíveis. Um dos objetivos é incentivar a colaboração na construção de código.

<center>
<img src="img/2018-10-03-introducao-ao-git/dplyr.png"  height="600" width="800">
</center>
...
- **Código** - Todos (com acesso ao repositório) terão acesso aos códigos utilizados, e poderão modificá-los:
    ...
    <center>
    <img src="img/2018-10-03-introducao-ao-git/codigo.png"  height="600" width="800">
    </center>
...
- **Histórico de modificações** - Todas as modificações contêm uma mensagem que explica as modificações feitas, sempre identificadas e reversíveis:
    ...
    <center>
    <img src="img/2018-10-03-introducao-ao-git/commits.png"  height="350" width="750">
    </center>

## O que é o GIT?  

Git é um sistema de controle de versão. Ele permite o gerenciamento do repositório, como *clone* e alteração de código, além de outras funcionalidades. Além disso, é um software livre.

[Download do Git](https://git-scm.com/downloads)

<center>
<img src="img/2018-10-03-introducao-ao-git/git_download.png"  height="550" width="800">
</center>
...
A flag `--global` deve ser usada ao fazer a configuração no seu computador pessoal.

## Configurando RStudio e GitLab
...
<center>
<img src="img/2018-10-03-introducao-ao-git/git_clone.png"  height="600" width="800">
</center>
...
<center>
<img src="img/RStudio_Git.png"  height="350" width="700">
</center>
...
<center>
<img src="img/pull.png"  height="70" width="450">
</center>
...
<center>
<img src="img/exemplo_commit.png"  height="600" width="800">
</center>
...
<center>
<img src="img/push.png"  height="70" width="450">
</center>
