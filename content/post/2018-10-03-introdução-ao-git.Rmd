...
Git é um sistema de controle de versão. Ele permite o gerenciamento do repositório, como *clone* e alteração de código, além de outras funcionalidades. Além disso, é um software livre. Faça [aqui](https://git-scm.com/downloads) o download do Git
...
<center>
![](/img/2018-10-03-introducao-ao-git/exemplo_commit.png){width=800px}
</center>
