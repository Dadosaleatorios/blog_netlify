...
Veja abaixo modelo de gráfico, utilizando a função do pacote básico e utilizando o pacote `ggplot2`:
...
* [`gganimate`](https://github.com/thomasp85/gganimate) - Para criar gráficos ggplot2 animados.
* [`ggiraph`](https://github.com/davidgohel/ggiraph) - Gráficos interativos
* [`ggrepel`](https://github.com/slowkow/ggrepel) - Modifica posição de texto para não sobrepor
* Entre outros.
