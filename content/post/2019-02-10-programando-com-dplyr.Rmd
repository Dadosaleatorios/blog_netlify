...
Ao passarmos o nome de uma coluna com aspas para ser usado em `group_by`, o `enquo()` (como vimos acima) não irá retornar o resultado desejado. Uma maneira de resolver esta questão é utilizar a função `sym()`. Iremos trabalhar com ela como trabalhamos com `enquo()`.
